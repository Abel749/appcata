...
return (
        ...
        <>
            ...
            <Descriptions column={1}  >
                <Descriptions.Item label="" contentStyle={imageStyle1} ><Image alt="" src="/dataDetail/product.png" width={240} height={300}
                                                   priority/>
            ...
            <Descriptions column={1} contentStyle={imageStyle2}>
                <Descriptions.Item label=""><Image alt=""  src={dataItem.DDSSrc} width={240} height={65} priority/>
                </Descriptions.Item>
            ...
            <div style={baseInfoDevStyle}>
                <div>
                    <Image src="/u2613.svg" alt=""  style={imageStyle3} width={6} height={35} priority/>
