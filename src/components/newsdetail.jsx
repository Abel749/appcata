...
import newsDetailStyles from "../styles/newsContent.module.css";
...
const NewsDetail= () => {
    ...
    return (
        <>
            ...
            <div className={newsDetailStyles.testDiv}>
                <Row>
                    <div className={newsDetailStyles.title}>
                        <h3>{newsData.title}</h3>
                    </div>
                </Row>
                <Row>
                    <div className={newsDetailStyles.dept}>
                        <p>{newsData.dept}</p>
                    </div>
                </Row>
                <Row>
                    <div className={newsDetailStyles.img}>
                        <Image src={newsData.image} alt="" width={800} height={540}  priority  />
                    </div>
                </Row>
                <Row>
                    <div>
                        <textarea defaultValue={newsData.content} className={newsDetailStyles.content}/>
                    </div>
                </Row>
                <Row>
                    <div className={newsDetailStyles.footer}>
                        <p>{newsData.dept}</p>
                    </div>
                </Row>
                <Row>
                    <div className={newsDetailStyles.footer2}>
                        <p>{newsData.date}</p>
                    </div>
                </Row>
