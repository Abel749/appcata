...
const Content2 = () => (
    ...
    <div className={indexStyle.content2}>
        <div>
            ...
            <Row>
                <Col className={indexStyle.outBaseDivHidden1}>
            ...
            <Col className={indexStyle.outBaseDivHidden2}>
                <div className={indexStyle.container2}>
                        <div className={indexStyle.outDivHidden}>
                            <p className={indexStyle.outH3Hidden}>研究资讯</p>
                        </div>
            ...
            <Col className={indexStyle.outBaseDivHidden3}>
            ...
            <Col className={indexStyle.outBaseDivHidden4}>
